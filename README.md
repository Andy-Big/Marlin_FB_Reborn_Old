...
<p align="center"><img src="IMG/robin_nano_12_.jpg" width="400px"></p>

Вариант **v_Robin_Nano_1.2_x16** подходит для этих же плат если пользователем был изменен микрошаг с 16 на 32.

2. **v_Robin_Nano_1.2_x16** - предназначена для плат MKS Robin Nano v1.2, известной так же как Flyingbear Reborn v2.0 в стоковой конфигурации:
<p align="center"><img src="IMG/robin_nano_12_.jpg"></p>
